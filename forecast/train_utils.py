...
def train_combinations(X_train,X_valid,y_train,y_valid,foo_evaluation,foo_predict,foo_model_type,basic_params,d_types,hyperparams,cates,log="", n_iter = N_ITER):
