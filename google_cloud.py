class BigQuery():
    ...
    def fast_export(self,query,destionatio_path,temp_dataset = 'TEMP45'):
        """
        ...
        table_name = self.gcCredentials.project_id+"."+temp_dataset+"."+rand_name
        self.create_table_from_q(query, table_name)

        # esa tabla la mando a un bucket
        self.export_table(destionatio_path,rand_name,dataset=temp_dataset)
